    ...
    <div className='p-4 pb-6 md:p-6'>
      <div className='flex items-center justify-between p-4 bg-white rounded-lg shadow-lg'>
        ...
        <div className="user-side">
          <ClerkLoading>          
            <div role="status">
                <svg aria-hidden="true" class="w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-[#633CFF]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
